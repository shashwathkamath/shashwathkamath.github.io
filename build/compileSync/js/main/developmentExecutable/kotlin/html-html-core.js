(function (root, factory) {
  ...
  var SkippableUpdater = kotlin_org_jetbrains_compose_runtime_runtime.$_$.k;
  ...
  var SideEffect = kotlin_org_jetbrains_compose_runtime_runtime.$_$.j;
  var RememberObserver = kotlin_org_jetbrains_compose_runtime_runtime.$_$.i;
  ...
  protoOf(Combine).contains_trwpob_k$ = function (other) {
  ...
  protoOf(Combine).asString_tqave4_k$ = function () {
  ...
  protoOf(Companion_1).get_Odd_18jn16_k$ = function () {
    return this.Odd_1;
  };
  protoOf(Companion_1).get_Even_wo17k3_k$ = function () {
    return this.Even_1;
  };
  protoOf(Companion_1).Functional_xwpqbx_k$ = function (a, b) {
    return new FunctionalImpl(a, b);
  };
  protoOf(Companion_1).Functional$default_o4esv6_k$ = function (a, b, $super) {
    a = a === VOID ? null : a;
    b = b === VOID ? null : b;
  ...
  protoOf(Companion_2).get_buildersCache_bdbdva_k$ = function () {
    return this.buildersCache_1;
  };
  protoOf(Companion_2).createBuilder_cjmhhk_k$ = function (tagName) {
  ...
  function Section_0(attrs, content, $composer, $changed, $default) {
    ...
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-145518388);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    ...
    if (!(($dirty & 91) === 18) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      if (isTraceInProgress()) {
        traceEventStart(-145518388, $dirty, -1, 'org.jetbrains.compose.web.dom.Section (Elements.kt:725)');
      }
  ...
  function H5_0(attrs, content, $composer, $changed, $default) {
    ...
    var content_0 = {_v: content};
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(921662032);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 14) === 0)
    ...
    if (!(($dirty & 91) === 18) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      if (isTraceInProgress()) {
        traceEventStart(921662032, $dirty, -1, 'org.jetbrains.compose.web.dom.H5 (Elements.kt:557)');
      }
  ...
  function B_0(attrs, content, $composer, $changed, $default) {
    _init_properties_Elements_kt__eyv5nt();
    var attrs_0 = {_v: attrs};
    var content_0 = {_v: content};
    var $composer_0 = $composer;
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-1081791415);
    var $dirty = $changed;
    if (!(($default & 1) === 0))
      $dirty = $dirty | 6;
    else if (($changed & 14) === 0)
    ...
    if (!(($dirty & 91) === 18) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      if (isTraceInProgress()) {
        traceEventStart(-1081791415, $dirty, -1, 'org.jetbrains.compose.web.dom.B (Elements.kt:587)');
      }
      TagElement(get_B(), attrs_0._v, content_0._v, $composer_0, 112 & $dirty << 3 | 896 & $dirty << 3);
      if (isTraceInProgress()) {
        traceEventEnd();
      }
    } else {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(B$lambda(attrs_0, content_0, $changed, $default));
    }
  }
  ...
  function B$lambda($attrs, $content, $$changed, $$default) {
    return function ($composer, $force) {
      B_0($attrs._v, $content._v, $composer, updateChangedFlags($$changed | 1), $$default);
      return Unit_getInstance();
    };
  }
  function el$factory() {
