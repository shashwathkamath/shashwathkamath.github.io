                    ...
                    Div({ classes("accordion-item") }) {
                        H2({ classes("accordion-header") }) {
                            Button({
                                ...
                                attr("type", "button") // Correct: string literal
                                attr("data-bs-toggle", "collapse")
                        ...
                        Div({
                            ...
                            Div({ classes("accordion-body") }) {
                                Ul({ classes("experience-details") }) {
                                    (job["details"] as List<String>).forEach { li ->
                                        Li { Text(li) }
                                    }
                                }
...
fun SkillsSection() {
    val skills = listOf(
        "Android Development", "React Native", "React JS", "Redux Thunk", "Java", "TypeScript", "Dart", "JavaScript", "Kotlin",
